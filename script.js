...
let SOFT_SKILLS="A B C D E F"

let CV=`Work
${WORK_EXPERIENCE1} ${WORK_EXPERIENCE2} ${WORK_EXPERIENCE3}

Education 
${EDUCATION_EXPERIENCE1} ${EDUCATION_EXPERIENCE2} ${EDUCATION_EXPERIENCE3}

Languages 
${LANGUAGES_SPOKEN1} ${LANGUAGES_SPOKEN2} ${LANGUAGES_SPOKEN3} ${LANGUAGES_SPOKEN4} ${LANGUAGES_SPOKEN5}
